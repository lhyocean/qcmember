package com.beijing.qchealth.qchealth_vip.view.niceSpinner;
...
public class NiceSpinner extends TextView {
	...
	private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.dimen_24);

        setGravity(Gravity.CENTER_VERTICAL| Gravity.LEFT);
        setPadding(resources.getDimensionPixelSize(R.dimen.dimen_24), defaultPadding, defaultPadding,
            defaultPadding);
        setClickable(true);
