...
import com.beijing.qchealth.qchealth_vip.adapter.HomeVipAdapter;
...
public class VipFragment extends BaseFragment {
    ...
    public View initRootView() {
        ...
        mRootView=View.inflate(mContext, R.layout.fragment_vip,null);
    ...
    public void setViews() {
        ...
        HomeVipAdapter mAdapter=new HomeVipAdapter(mContext,null);
