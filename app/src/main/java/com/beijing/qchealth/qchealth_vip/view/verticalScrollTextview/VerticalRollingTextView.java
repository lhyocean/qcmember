...
public class VerticalRollingTextView extends View {
    ...
    public VerticalRollingTextView(Context context, AttributeSet attrs) {
        ...
        mPaint.setTextSize(typedArray.getDimensionPixelOffset(R.styleable.VerticalRollingTextView_android_textSize, (int) (density * 13)));
        typedArray.recycle();
        mPaint.setColor(context.getResources().getColor(R.color.color_293535));
