...
public class DiscoveryCourseAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<TestBean> mDate;

    public DiscoveryCourseAdapter(Context mContext, List<TestBean> mDate) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=View.inflate(mContext, R.layout.discovery_item_course,null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ImageUtil.loadPicNet(Common.PHOTOS[0],mHolder.img);
//        
