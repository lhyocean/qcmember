...
public class RoundedImageView extends ImageView {
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_border_width1, -1);
    ...
    borderColor = a.getColorStateList(R.styleable.RoundedImageView_border_color1);
    if (borderColor == null) {
